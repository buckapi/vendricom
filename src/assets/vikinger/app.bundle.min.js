            ...
            o.createChart(t, {
                ...
                data: {
                    datasets: [{
                        ...
                        backgroundColor: ["#005ac6", "#23d2e2", "#4f91ff", "#3ad2fe"],
                        hoverBackgroundColor: ["#005ac6", "#23d2e2", "#4f91ff", "#3ad2fe"],
                        borderWidth: 0
                    }],
        ...
        i.querySelector("#ve-monthly-report-ratio-chart", function(e) {
            ...
            o.createChart(t, {
                ...
                data: {
                    datasets: [{
                        data: [12.5, 87.5],
                        backgroundColor: ["#005ac6", "#23d2e2"],
                        hoverBackgroundColor: ["#005ac6", "#23d2e2"],
                        borderWidth: 0
                    }],
            ...
            var t = e[0].getContext("2d")
              , n = {
                ...
                datasets: [{
                    ...
                    borderDashOffset: 0,
                    borderJoinStyle: "bevel",
                    pointBorderColor: "#005ac6",
                    pointBackgroundColor: "#fff",
                    pointBorderWidth: 2,
                    pointHoverRadius: 4,
                    pointHoverBorderColor: "#005ac6",
                    pointHoverBackgroundColor: "#fff",
                    pointHoverBorderWidth: 2,
                    pointRadius: 4,
                    pointHitRadius: 5
