...
var AdminService = class _AdminService extends CrudService {
  get baseCrudPath() {
    return "/api/admins";
  }
  update(e2, t2, s2) {
    return __async(this, null, function* () {
      return __superGet(_AdminService.prototype, this, "update").call(this, e2, t2, s2).then((e3) => (this.client.authStore.model?.id === e3.id && void 0 === this.client.authStore.model?.collectionId && this.client.authStore.save(this.client.authStore.token, e3), e3));
    });
  }
  delete(e2, t2) {
    return __async(this, null, function* () {
      return __superGet(_AdminService.prototype, this, "delete").call(this, e2, t2).then((t3) => (t3 && this.client.authStore.model?.id === e2 && void 0 === this.client.authStore.model?.collectionId && this.client.authStore.clear(), t3));
    });
  }
  authResponse(e2) {
...
var RecordService = class _RecordService extends CrudService {
  ...
  getFullList(e2, t2) {
    return __async(this, null, function* () {
      if ("number" == typeof e2)
        return __superGet(_RecordService.prototype, this, "getFullList").call(this, e2, t2);
  ...
  update(e2, t2, s2) {
    return __async(this, null, function* () {
      return __superGet(_RecordService.prototype, this, "update").call(this, e2, t2, s2).then((e3) => (this.client.authStore.model?.id !== e3?.id || this.client.authStore.model?.collectionId !== this.collectionIdOrName && this.client.authStore.model?.collectionName !== this.collectionIdOrName || this.client.authStore.save(this.client.authStore.token, e3), e3));
    });
  }
  delete(e2, t2) {
    return __async(this, null, function* () {
      return __superGet(_RecordService.prototype, this, "delete").call(this, e2, t2).then((t3) => (!t3 || this.client.authStore.model?.id !== e2 || this.client.authStore.model?.collectionId !== this.collectionIdOrName && this.client.authStore.model?.collectionName !== this.collectionIdOrName || this.client.authStore.clear(), t3));
    });
  }
  authResponse(e2) {
